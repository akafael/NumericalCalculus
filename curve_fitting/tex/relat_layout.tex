...
%\usepackage[utf8]{inputenc} % não usado com lualatex
%\usepackage{lmodern}
...
\usepackage{fullpage} % aumenta a área útil
...
%     Outros ----------------------------------------------------------------------------
      \addto\captionsbrazilian{\renewcommand{\contentsname}{\'Indice}} % Muda nome dos contents
